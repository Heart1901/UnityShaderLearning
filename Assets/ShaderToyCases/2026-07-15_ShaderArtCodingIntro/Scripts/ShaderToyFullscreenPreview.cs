...
public sealed class ShaderToyFullscreenPreview : MonoBehaviour
{
    [SerializeField] private Material displayMaterial;
    [SerializeField, Range(0.1f, 50f)] private float distance = 5f;
    [SerializeField] private string quadName = "ShaderToy Fullscreen Quad";
