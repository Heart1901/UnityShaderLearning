...
public sealed class JourneyTributeFullscreenPreview : MonoBehaviour
{
    [SerializeField] private Material displayMaterial;
    [SerializeField, Range(0.1f, 50f)] private float distance = 5f;
    [SerializeField] private string quadName = "Journey Tribute Fullscreen Quad";
    ...
    private static Mesh CreateQuadMesh()
    {
        Mesh mesh = new Mesh
        {
            name = "Journey Tribute Preview Quad"
        };
